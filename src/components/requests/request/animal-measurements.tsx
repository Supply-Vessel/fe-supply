...
import { WeightChart } from "@/src/components/requests/weight-chart"
...
export function AnimalMeasurements({ animal, animalId, userId,vesselId, handleUpdateDataPagination, pagination }: AnimalMeasurementsProps) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <Link href={`/${vesselId}/animals/${animalId}/measurements/new`} className="w-full sm:w-auto">
