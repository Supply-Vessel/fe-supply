...
import { AnimalMedicalRecords } from "@/src/components/requests/animal/animal-medical-records"
import { AnimalMeasurements } from "@/src/components/requests/animal/animal-measurements"
import { AnimalExperiments } from "@/src/components/requests/animal/animal-experiments"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/src/components/ui/tabs"
import { AnimalBasicInfo } from "@/src/components/requests/animal/animal-basic-info"
import { AnimalGenealogy } from "@/src/components/requests/animal/animal-genealogy"
import { Avatar, AvatarFallback, AvatarImage } from "@/src/components/ui/avatar"
import { QuickActionPanel } from "@/src/components/requests/quick-action-panel"
      ...
      <div className="grid gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="flex gap-2">
            ...
            <Button
              onClick={() => {
                router.push(`/${labId}/requests/${animalId}/measurements/new`)
              }}
              size="sm"
            >
